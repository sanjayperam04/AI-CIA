...
def alpha_beta(depth, nodeIndex, maximizingPlayer, values, alpha, beta, level=0):
    if depth == 0:
    ...
    if maximizingPlayer:
        ...
        for i in range(2):
            value = alpha_beta(depth - 1, nodeIndex * 2 + i, False, values, alpha, beta, level + 1)
        ...
        for i in range(2):
            value = alpha_beta(depth - 1, nodeIndex * 2 + i, True, values, alpha, beta, level + 1)
